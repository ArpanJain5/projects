                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <ul class="dropdown">
                                    <li><a href="seller-registration.jsp">Seller Registration</a></li>
                                    <li><a href="customer-registration.jsp">Customer Registration</a></li>
                                </ul>
                            </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__form">
                        ...
                        <input type="hidden" class="email" name="email" value="<%=s.getEmail() %>">
