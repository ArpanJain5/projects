...
%>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-3">
            <h3 class="tittle text-center"><span class="sub-tittle">Find Us</span>Customer Profile</h3>
            <div class="row contact-main-info mt-5">
                <div class="col-md-6 contact-right-content">
                    <form action="CustomerController" method="post">
                    	<input type="hidden" name="id" value="<%=u.getId()%>">
                        <input type="text" name="name" value="<%=u.getName()%>" required="">
                        <input type="text" name="contact" value="<%=u.getContact()%>" required="">
                        <input type="text" name="address" value="<%=u.getAddress()%>" required="">
                        <input type="text" name="pincode" value="<%=u.getPincode()%>" required="">
                        <input type="email" class="email" name="email" value="<%=u.getEmail()%>" required="">
                        <div class="read mt-3">
