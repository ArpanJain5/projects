...
%>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-3">
            <h3 class="tittle text-center"><span class="sub-tittle">Find Us</span>Product Details</h3>
            <div class="row contact-main-info mt-5">
                <div class="col-md-6 contact-right-content">
                    <form action="SellingController" method="post">
                        ...
                        <div class="read mt-3">
                            <input type="submit" value="Upload Details" name="action">
                        </div>
                    </form>
                </div>
